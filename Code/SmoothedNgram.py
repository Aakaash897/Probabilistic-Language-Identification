...
for k,v in ENmap1_bi.items():
    toCalculate=list(k)
    if len(toCalculate) == 2:
        ENprob_bi[k]=(ENmap1_bi.get(k)+0.5)/((singleCount.get(toCalculate[0]))+(len(ENmap1_bi.keys())*len(ENmap1_bi.keys())*0.5))
    else:
        ENprob_bi[k]=(ENmap1_bi.get(k)+0.5)/((singleCount.get("<s>"))+(len(ENmap1_bi.keys())*len(ENmap1_bi.keys())*0.5))
...
for k,v in FRmap1_bi.items():
    toCalculate=list(k)
    if len(toCalculate) == 2:
        FRprob_bi[k]=(FRmap1_bi.get(k)+0.5)/((singleCount.get(toCalculate[0]))+(len(FRmap1_bi.keys())*len(FRmap1_bi.keys())*0.5))
    else:
        FRprob_bi[k]=(FRmap1_bi.get(k)+0.5)/((singleCount.get("<s>"))+(len(FRmap1_bi.keys())*len(FRmap1_bi.keys())*0.5))
